...
public:
    ...
    using value_type = std::tuple<std::size_t, typename extract_value_type<it_reference_t<Containers>>::type...>;
...
private:
    ...
    explicit indexed_zipper_iterator(iterator_tuple const& it_tuple, std::size_t max, std::size_t idx)
