...
void test_spawn_entities() {
    ...
    std::cout << "✓ spawn_entity works (entities: " << entity0 << ", " << entity1 << ", " << entity2
              << ")" << std::endl;
}
...
void test_ecs_system() {
    ...
    std::cout << "  Player moved to (" << positions[player]->x << ", " << positions[player]->y
              << ")" << std::endl;
    std::cout << "  Static object stayed at (" << positions[static_obj]->x << ", "
              << positions[static_obj]->y << ")" << std::endl;
}
