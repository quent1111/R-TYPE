...
SpriteConfig CustomLevelLoader::parse_sprite(const void* json_ptr) {
    ...
    if (j.contains("texture_path")) config.texture_path = j["texture_path"].get<std::string>();
    if (j.contains("frame_width")) config.frame_width = j["frame_width"].get<int>();
    if (j.contains("frame_height")) config.frame_height = j["frame_height"].get<int>();
    if (j.contains("frame_count")) config.frame_count = j["frame_count"].get<int>();
    if (j.contains("frame_duration")) config.frame_duration = j["frame_duration"].get<float>();
    if (j.contains("scale_x")) config.scale_x = j["scale_x"].get<float>();
    if (j.contains("scale_y")) config.scale_y = j["scale_y"].get<float>();
    if (j.contains("mirror_x")) config.mirror_x = j["mirror_x"].get<bool>();
    if (j.contains("mirror_y")) config.mirror_y = j["mirror_y"].get<bool>();
    if (j.contains("rotation")) config.rotation = j["rotation"].get<float>();
...
ProjectileConfig CustomLevelLoader::parse_projectile(const void* json_ptr) {
    ...
    if (j.contains("type")) config.type = j["type"].get<std::string>();
    if (j.contains("speed")) config.speed = j["speed"].get<float>();
    if (j.contains("damage")) config.damage = j["damage"].get<int>();
...
EnemyDefinition CustomLevelLoader::parse_enemy(const void* json_ptr) {
    ...
    if (j.contains("id")) enemy.id = j["id"].get<std::string>();
    if (j.contains("name")) enemy.name = j["name"].get<std::string>();
    if (j.contains("health")) enemy.health = j["health"].get<int>();
    if (j.contains("speed")) enemy.speed = j["speed"].get<float>();
    if (j.contains("damage")) enemy.damage = j["damage"].get<int>();
    if (j.contains("score_value")) enemy.score_value = j["score_value"].get<int>();
...
BossDefinition CustomLevelLoader::parse_boss(const void* json_ptr) {
    ...
    if (j.contains("id")) boss.id = j["id"].get<std::string>();
    if (j.contains("name")) boss.name = j["name"].get<std::string>();
    if (j.contains("health")) boss.health = j["health"].get<int>();
    if (j.contains("damage")) boss.damage = j["damage"].get<int>();
    if (j.contains("score_value")) boss.score_value = j["score_value"].get<int>();
...
EnvironmentConfig CustomLevelLoader::parse_environment(const void* json_ptr) {
    ...
    if (j.contains("background_texture")) config.background_texture = j["background_texture"].get<std::string>();
    if (j.contains("scroll_speed")) config.scroll_speed = j["scroll_speed"].get<float>();
    if (j.contains("scroll_infinite")) config.scroll_infinite = j["scroll_infinite"].get<bool>();
    if (j.contains("background_static")) config.background_static = j["background_static"].get<bool>();
...
std::optional<CustomLevelConfig> CustomLevelLoader::load_from_file(const std::string& filepath) {
    ...
    try {
        ...
        if (j.contains("metadata")) {
            ...
            if (meta.contains("id")) config.id = meta["id"].get<std::string>();
            if (meta.contains("name")) config.name = meta["name"].get<std::string>();
        }
