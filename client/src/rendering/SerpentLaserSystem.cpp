...
void SerpentLaserSystem::spawn_core_particles(float start_x, float start_y, float angle, float length) {
...
void SerpentLaserSystem::spawn_glow_particles(float start_x, float start_y, float angle, float length) {
    float cos_a = std::cos(angle);
    float sin_a = std::sin(angle);
    float perp_cos = std::cos(angle + 3.14159f / 2.0f);
    float perp_sin = std::sin(angle + 3.14159f / 2.0f);
...
void SerpentLaserSystem::spawn_spark_particles(float start_x, float start_y, float angle, float length) {
    float cos_a = std::cos(angle);
    float sin_a = std::sin(angle);
    float perp_cos = std::cos(angle + 3.14159f / 2.0f);
    float perp_sin = std::sin(angle + 3.14159f / 2.0f);
