...
inline const char* colorBlindnessModeToString(ColorBlindnessMode mode) {
    switch (mode) {
        ...
        case ColorBlindnessMode::HighContrast: return "HighContrast";
...
inline ColorBlindnessMode stringToColorBlindnessMode(const std::string& str) {
    if (str == "Protanopia")   return ColorBlindnessMode::Protanopia;
    if (str == "Deuteranopia") return ColorBlindnessMode::Deuteranopia;
    if (str == "Tritanopia")   return ColorBlindnessMode::Tritanopia;
    if (str == "HighContrast") return ColorBlindnessMode::HighContrast;
...
inline ColorBlindnessMode fromClientColorBlindMode(int client_mode) {
    switch (client_mode) {
        case 0: return ColorBlindnessMode::Normal;
        case 1: return ColorBlindnessMode::Protanopia;
        case 2: return ColorBlindnessMode::Deuteranopia;
        case 3: return ColorBlindnessMode::Tritanopia;
        case 4: return ColorBlindnessMode::HighContrast;
        default: return ColorBlindnessMode::Normal;
    }
}
