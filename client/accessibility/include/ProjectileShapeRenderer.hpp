...
public:
     ...
     * @param color Couleur
     */
    void drawPlayerProjectile(sf::RenderWindow& window,
                              float x, float y,
                              float size,
     ...
     * @param color Couleur
     */
    void drawEnemyProjectile(sf::RenderWindow& window,
                            float x, float y,
                            float size,
                            const sf::Color& color);
     ...
     */
    void drawProjectilePattern(sf::RenderWindow& window,
                               float x, float y,
                               float size,
...
private:
     ...
     */
    void drawCross(sf::RenderWindow& window, float x, float y, float size,
